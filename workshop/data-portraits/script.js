...
var portraitRules = {
  ".age-0-29": {
    visibility: (d) =>
      d.age.match(/0-29|30-44|45-59|60\+/) ? "visible" : "hidden",
  },
  ".age-30-44": {
  ...
  ".morning-person": {
    visibility: (d) =>
      d.morning.match(/Morning person|Both/) ? "visible" : "hidden",
  },
  ".night-owl": {
    visibility: (d) =>
      d.morning.match(/Night owl|Both/) ? "visible" : "hidden",
  },
  ".shower-sing": {
  ...
  ".pets-0": {
    visibility: (d) =>
      d.pets.match(/None|1-3|4-9|10\+/) ? "visible" : "hidden",
  },
  ".pets-1-3": {
  ...
  ".phone-arms-reach": {
    visibility: (d) =>
      d.keepPhone == "Within arm reach" ? "visibile" : "hidden",
  },
  ".phone-same-room": {
    visibility: (d) =>
      d.keepPhone == "In the same room but far" ? "visibile" : "hidden",
  },
  ".phone-another-room": {
    visibility: (d) =>
      d.keepPhone == "In another room" ? "visibile" : "hidden",
  },
  ".pencil-pen": {
    "stroke-dasharray": (d) => (d.pencilPen == "Pen" ? "0 0" : "4 7"),
    stroke: (d) =>
      d.pencilPen == "Pen" ? "#333" : d.pencilPen == "Pencil" ? "#888" : "#fff",
  },
  ".introvert": {
  ...
  ".friends-0": {
    visibility: (d) =>
      d.friends.match(/None|1-3|4-9|10\+/) ? "visible" : "hidden",
  },
  ".friends-1-3": {
