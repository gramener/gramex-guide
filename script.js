...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.setAttribute(
    "data-bs-offset",
    parseInt(getComputedStyle(document.querySelector("html"))["scroll-padding-top"])
  );
  ...
  for (let el of document.querySelectorAll(".codehilite")) {
    ...
    el.insertAdjacentHTML("afterbegin", '<button class="copy-button copy-button btn btn-xs btn-dark text-uppercase pos-tr mt-2 me-n2"><i class="fas fa-copy"></i></button>')
  }
